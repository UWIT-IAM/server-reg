...
<tr>
  ...
  <td width=20></td>
  <td valign=bottom class=head>Enterprise Directory Service Registration</td>
</tr>
</table>
...
<!-- BDB: already -->
<p class=msg>
Server {CN} is already OK for EDS access.
<!-- EDB: already -->
...
<!-- BDB: submitted -->
<p class=msg>
Your request for EDS accessfor server {CN} has been submitted.
<p>
<!-- EDB: submitted -->
