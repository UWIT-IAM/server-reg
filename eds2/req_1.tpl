...
<form action="{ROOT}/" method="get" name="request">
  <input type=hidden name=req value=req_2>
...
<tr><td colspan="99"><p><b>Application DNS name:</b>
   Please enter the DNS name of your client application.  
 </td></tr>
  
<tr><td width="40" colspan="2"></td><td>
   <input type="text" name="cn" size="40" value="{CN}">
     </td></tr>
# this used only if we're doing application ownership.  Otherwise leave it out
## <tr><td colspan="99"><p>
##   Your UW NetID must either be listed in UW DNS
##   as a contact for this DNS name or must be in this
##    application's authorization group.
## 
##  See <a href="http://www.washington.edu/computing/eds/person.html#access" >UW Person
##  Directory Service</a> and 
