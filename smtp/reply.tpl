...
# 
# $HeadURL: https://svn.cac.washington.edu/svn/ateam/mailscripts/trunk/server-reg/reply.tpl $
# $Id: reply.tpl 747 2012-10-26 00:37:06Z hubert@u.washington.edu $
#
...
email to UW Information Technology staff. You will receive 
confirmation and a tracking number.
<p>
A notice has been sent to "{TO}" for an opportunity to 
review and weigh in. No response is needed for them to give approval.
<p>
You should get an email response within three working days to let 
you know the outcome, or if there is some problem.
...
confirmation and a tracking number.
<p>
A notice has been sent to "{DEAN}" for an opportunity to 
review and weigh in. No response is needed for them to give approval.
<p>
You should get an email response within three working days to let 
you know the outcome, or if there is some problem.
